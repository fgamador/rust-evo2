...
impl Cell {
    pub fn new(bio_constants: &Rc<BioConstants>, cell_constants: CellConstants, energy: f32) -> Self {
        Cell {
...
mod tests {
    ...
    fn new_cell_has_full_health() {
        let cell = Cell::new(&Rc::new(BioConstants::DEFAULT), CellConstants::DEFAULT, 0.0);
    ...
    fn cell_uses_energy() {
        ...
        let mut cell = Cell::new(&bio_constants, CellConstants::DEFAULT, 10.0);
    ...
    fn cell_eats_food() {
        ...
        let mut cell = Cell::new(&bio_constants, cell_constants, 1.0);
    ...
    fn cell_expends_energy_eating() {
        ...
        let mut cell = Cell::new(&bio_constants, cell_constants, 5.0);
    ...
    fn cell_digests_food() {
        ...
        let mut cell = Cell::new(&bio_constants, cell_constants, 10.0);
        cell.step(&environment);
    ...
    fn cell_with_insufficient_energy_does_not_reproduce() {
        ...
        let mut cell = Cell::new(&Rc::new(BioConstants::DEFAULT), cell_constants, 3.0);
    ...
    fn cell_with_insufficient_food_does_not_reproduce() {
        ...
        let mut cell = Cell::new(&Rc::new(BioConstants::DEFAULT), cell_constants, 1.0);
        let environment = CellEnvironment {
            food_per_cell: 3.0,
            ..CellEnvironment::DEFAULT
        };
